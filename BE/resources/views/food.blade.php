...
<body>
    <div class="nav">
        ...
        <div class="tab home nav-active"><img src="{{asset('assets/img/food-home.svg')}}" alt=""></div>
    ...
    <div class="main-container">
        ...
        <div class="category-wrapper">
            ...
            <div class="container">
                ...
                <div class="container1 category">
                    <div class="container2"><img src="{{asset('storage/category/'.$category->gambar)}}" alt=""></div>
                    <div class="text-regular-bold">{{$category->nama}}</div>
                </div>
                </a>
            </div>
            @endforeach
